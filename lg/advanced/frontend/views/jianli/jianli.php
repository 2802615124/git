	...
	<div id="header">
    	<div class="wrapper">
            ...
            <ul id="navheader" class="reset">
    			...
    			<li class="current"><a rel="nofollow" href="?r=jianli/jianli">我的简历</a></li>
	    	</ul>
            ...
            <div class="dn" id="noticeTip">
            	<span class="bot"></span>
				<span class="top"></span>
				<a target="_blank" href="?r=jianli/delivery"><strong>0</strong>条新投递反馈</a>
            ...
            <div class="content_l">
            	<div class="fl" id="resume_name">
	            	<div class="nameShow fl">
                            ...
                            <span class="rename">重命名</span> | <a target="_blank" href="?r=jianli/preview">预览</a>
                        </div>
           ...
           //                                   $("#timeEnd").text(date);
                            ...
                            <form id="profileForm">
                                <table>
                                    <tbody><tr>
                                        ...
                                        <td>
                                            <input type="text" placeholder="姓名" value="<?=$username?>" name="name" id="nameVal">
                                        </td>
                                        <td valign="top"></td>
                                        <td>
                   ...
                   <script>
                    ...
                    <div class="profile_box" id="expectJob">
                        ...
                        <!--期望工作js-->
                            <input type="hidden" value="<?=$resume['r_id'] ?>" id="r_id">
                            <script>
                                  ...
                                  $("#expect1").click(function(){
                                      ...
                                      $.ajax({
                                          url:"?r=jianli/expectint",
                                          data:{expectCity:expectCity,expectSalary:expectSalary,expectPosition:expectPosition,r_id:r_id,current:current},
                                          type:"post",
                                          // dataType:"json",
                                          success:function(msg){
                                             alert(msg)
                    ...
                    <div class="profile_box" id="workExperience">
                        ...
                        <script>
                            $(document).on('click','#expence1',function(){
                                 ...
                                 var r_id=$("#r_id").val();
                                 $.ajax({
                                          url:"?r=jianli/exprienceint",
                                          data:{companyName:companyName,positionName:positionName,r_id:r_id,YearStart:YearStart,MonthStart:MonthStart,YearEnd:YearEnd,MonthEnd:MonthEnd},
                                          type:"post",
                                          // dataType:"json",
                                          success:function(msg){
                                             alert(msg)
                ...
                $(document).on('click','#projectExperience1',function(){
                                 ...
                                 $.ajax({
                                          url:"?r=jianli/proint",
                                          data:{projectName:projectName,thePost:thePost,r_id:r_id,YearStart:YearStart,MonthStart:MonthStart,YearEnd:YearEnd,MonthEnd:MonthEnd,projectDescription:projectDescription},
                                          type:"post",
                                          // dataType:"json",
                                          success:function(msg){
                                             alert(msg)
                ...
                $(document).on('click','#educationalBackground1',function(){
                                 ...
                                 $.ajax({
                                          url:"?r=jianli/eduint",
                                          data:{schoolName:schoolName,degree:degree,r_id:r_id,professionalName:professionalName,schoolYearEnd:schoolYearEnd,schoolYearStart:schoolYearStart},
                                          type:"post",
                                          // dataType:"json",
                                          success:function(msg){
                                             alert(msg)
                    ...
                    <div class="descriptionEdit dn">
                        <form method="post">
                            <table>
                                <tbody><tr>
                                    <td colspan="2">
                                        <input type="hidden" id="user_id" value="<?=$resume['uid']?>" name="user_id">
                ...
                $(document).on('click','#content',function(){
                                 ...
                                 var r_id=$("#r_id").val();
                                 $.ajax({
                                          url:"?r=jianli/countint",
                                          data:{content:content,r_id:r_id},
                                          type:"post",
                                          // dataType:"json",
                                          success:function(msg){
                                             alert(msg)
                ...
                <script>
                     $(document).on('click','#profile_save',function(){
                                 ...
                                 $.ajax({
                                          url:"?r=jianli/linkint",
                                          data:{worklink:worklink,s_textarea:s_textarea,r_id:user_id},
                                          type:"post",
                                          // dataType:"json",
                                          success:function(msg){
                                             alert(msg)
