	...
	<div id="header">
    	<div class="wrapper">
        	...
        	<dl class="collapsible_menu">
                ...
                <dd style="display: none;"><a rel="nofollow" href="?r=jianli/jianli">我的简历</a></dd>
                <dd style="display: none;"><a href="?r=jianli/collections">我收藏的职位</a></dd>
                <dd style="display: none;"><a href="?r=jianli/toudi">我投递的职位 <span id="noticeNo" class="red dn">(0</span></a></dd>
                <dd class="btm" style="display: none;"><a href="?r=jianli/subscribe">我的订阅</a></dd>
                <dd style="display: none;"><a href="?r=create/create">我要招人</a></dd>
        ...
        <div class="clearfix">
            	...
            	<dl class="c_delivery">
                    ...
                    <dd>
                    	<div class="delivery_tabs">
                    		<ul class="reset">
                    			                    			<li class="current">
                    				<a href="?r=jianli/delivery?tag=-1">全部</a>
                    			</li>
                    			                    			<li>
                    				<a href="?r=jianli/delivery?tag=5">投递成功</a>
                    			</li>
                    			<li>
                    				<a href="?r=jianli/delivery?tag=1">被查看</a>
                    			</li>
                    			<li>
                    				<a href="?r=jianli/delivery?tag=2">通过初筛</a>
                    			</li>
                    			<li>
                    				<a href="?r=jianli/delivery?tag=3">通知面试</a>
                    			</li>
                    			<li class="last">
                    				<a href="?r=jianli/delivery?tag=4">不合适</a>
                    			</li>
                    		</ul>
                    	</div>
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
            		<h2>我的信息</h2>
            		<a href="?r=jianli/collections">我收藏的职位</a>
            		<br>
            		            		<a href="?r=jianli/toudi" target="_blank">我投递的职位<span id="noticeNoPage" class="red dn">&nbsp;(0)</span></a>
            		<br>
            		            		<a target="_blank" href="?r=jianli/subscribe">我订阅的职位</a>
            		            		<br>
            		<a target="_blank" href=?r=jianli/mList">我的职位推荐</a>
            		            	</div><!--end #myInfo-->
