...
<p>3、每周定期举办足球、羽毛球、篮球及员工深度互动等文体活动。</p>
				                        ...
				                        <div>
								          <span> 你已有可投递的在线简历：<a title="jason的简历" target="_blank" href="?r=jianli/jianli"><strong>jason的简历</strong></a></span><br>
								          <span>简历更新于2014-07-01 15:53</span>
				                        </div>
				                        <span class="setBtns">
				                        	<a target="_blank" title="预览" href="?r=create/preview">预览</a> |
				                        	<a title="修改" target="_blank" href="?r=jianli/jianli">修改</a>
				                        </span>
				                    </dd>
	    	...
	    	<tr>
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm">
            			...
            			<div class="setBtns">
            					            				<a target="_blank" href="?r=create/preview">预览</a> |
...
<!-- 投递简历时  - 设置默认投递简历 -->
	...
	<div style="height:240px;" class="popup" id="loginPop">
       	<form id="loginForm">
		    ...
		    <a class="fr" href="?r=login/reset">忘记密码？</a>
		    <input type="submit" value="登 &nbsp; &nbsp; 录" id="submitLogin">
		</form>
		<div class="login_right">
			<div>还没有拉勾帐号？</div>
			<a class="registor_now" href="?r=login/register">立即注册</a>
