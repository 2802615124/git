...
<div id="body">
    ...
    <div id="container">
            ...
            <div class="sidebar">
                <a class="btn_create" href="?r=create/create">发布新职位</a>
                <dl class="company_center_aside">
        <dt>我收到的简历</dt>
    <dd>
        <a href="?r=create/canint">待定简历</a>
    </dd>
    <dd>
        <a href="?r=create/haverefuseresumes">不合适简历</a>
    </dd>
    <dd class="btm">
        <a href="?r=create/autofilterresumes">自动过滤简历</a>
            </dd>
</dl>
<dl class="company_center_aside">
        <dt>我发布的职位</dt>
    ...
    <dd>
        <a href="?r=create/positions">已下线职位</a>
    </dd>
    </dl>
            </div><!-- end .sidebar -->
            <div class="content">
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
			                                ...
			                                <div class="resumeShow">
			                                    ...
			                                    <div class="resumeIntro">
			                                        <h3 class="unread">
													<a target="_blank" title="预览<?php echo $val['name']; ?>的简历" href="resumeView.html?deliverId=1686182">
			                                   		<?php echo $val['name']; ?>
			                                        </a>
			                                        <em></em>
			                                        </h3>
			                                        <span class="fr">投递时间：<?php echo $val['add_time']; ?></span>
			                                        <div>
			                                        	<?php echo $val['name']; ?>/ <?php echo $val['sex']; ?>/ <?php echo $val['education']; ?>/ <?php echo $val['work_exp']; ?>		                                            			     <br>
			                                ...
			                                <div class="contactInfo">
			                                	<span class="c9">电话：</span><?php echo $val['tel']; ?>   &nbsp;&nbsp;&nbsp;
			                                    <span class="c9">邮箱：</span><a href="mailto:888888888@qq.com"><?php echo $val['email']; ?></a>
			                                </div>
			                            </li>
		                            	</ul><!-- end .resumeLists -->
		                            	<?php } ?>
