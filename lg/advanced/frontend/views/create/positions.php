                    ...
                    <dd>		
                    	<?php foreach ($arr as $key => $val) { ?>
			                	...
			                	<ul class="reset my_jobs">
				                	<li data-id="149594">
		                                    <h3>
		                                        <a target="_blank" title="随便写" href="http://www.lagou.com/jobs/149594.html"><?=$val['pos_name'] ?></a>
		                                        <span><?=$val['pos_city'] ?></span>
		                                        </h3>
		                                    	<span class="receivedResumeNo"><a href="unHandleResumes.html?positionId=149594">应聘简历（<?=$val['pos_id'] ?>）</a></span>
		                                  		<div><?=$val['pos_nat'] ?> / <?=$val['pos_salary_start'] ?>k-<?=$val['pos_salary_end'] ?>k / <?=$val['year'] ?> / <?=$val['edu'] ?></div>
