            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	...
                    	<form action="index.php?r=create/create" method="post" id="jobForm">
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td>工作城市</td>
                                	<td>
                                    	<input type="text" placeholder="请输入工作城市，如：北京" value="上海" name="workAddress" id=" ">
                                    </td>
                                </tr>
                            </tbody></table>
