...
<div id="body">
	<div id="header">
    	<div class="wrapper">
            ...
            <dl class="collapsible_menu">
                ...
                <dd><a href="?r=create/positions">我发布的职位</a></dd>
                <dd><a href="?r=create/positions">我收到的简历</a></dd>
                <dd><a href="?r=comp/myhome">我的公司主页</a></dd>
                <dd><a href="?r=jianli/jianli">我要找工作</a></dd>
                <dd><a href="?r=login/accountbind">帐号设置</a></dd>
                <dd><a rel="nofollow" href="?r=login/login">退出</a></dd>
            </dl>
        </div>
    </div><!-- end #header -->
    <div id="container">
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
     	        <dt><h3>帐号设置</h3></dt>
                <dd><a href="?r=login/accountBind">帐号绑定</a></dd>
     	...
     	<table>
         	...
         	<tr>
         		<td align="center">
         			...
         			<a class="cancel" href="?r=login/login">退出当前帐号</a>
         		</td>
         	</tr>
        </tbody></table>
    </div><!--/#bindTips-->
