...
<div id="body">
    ...
    <div id="container">
            ...
            <div class="content_l">
                  ...
                  <li class="clearfix" data-id="<?=$data['pos_id']?>">
		            																		            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="?r=index/list_show&&pos_id= <?=$data['pos_id']?>" target="_blank"><?= $data['pos_name'];?></a>

			                            <span class="c9"><?= $data['pos_city']?></span>
			                            			                        </div>
			                        <span><em class="c7">月薪： </em><?= $data['pos_salary_end']?></span>
			                        <span><em class="c7">经验：</em> 3-5年</span>
			                        <span><em class="c7">最低学历： </em>本科</span>
			                        <br />
			                        <span><em class="c7">职位诱惑：</em><?= $data['pos_tem']?></span>
			                        <br />
				                    <span>1天前发布</span>
			                        <!-- <a  class="wb">分享到微博</a>-->
			                    </div>
...
<br>6、熟悉互联网，具有积克精神，精通设计美学，可做设计者优先。&nbsp;
	                ...
	                <dd class="resume resume_web">
				        <div style="width:400px;">
				          <span> 你已设置默认投递简历：<a title="jason的简历" target="_blank" href="resume/myresume.html"><strong>在线简历：</a></span><br>
								...
								<p>
									想知道HR在看简历嘛？<br>
          							...
          							<span>&lt;&lt; 扫一扫，给你解决</span>
                                        ...
                                        <dd>
                                        	                    				                   		<!-- 用户是否激活 0-否；1-是 -->
               <span id="r_id" val="<?=$resume['r_id']?>"></span>
	           <a title="投个简历" class="btn fr btn_apply" id="toudi" href="javascript:void(0)">投个简历</a>
                                ...
                                <script>
                                    $(document).on('click','#toudi',function(){
                                        var r_id=$("#r_id").attr('val');
                                        var firm_id=$("#firm_id").attr('val');
                                        $.ajax({
                                            type: "post",
                                            url: "?r=index/toudi",
                                            data: {r_id:r_id,firm_id:firm_id},
	    	...
	    	<tr>
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm">
            			...
            			<div class="setBtns">
            					            				<a target="_blank" href="?r=jianli/preview">预览</a> |
	            										<a target="_blank" href="?r=jianli/jianli">修改</a>
            			</div>
	            		<div class="clear"></div>
	            		<label class="radio">
