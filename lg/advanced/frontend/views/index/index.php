...
use yii\helpers\url;
$db = Yii::$app->db;
$na = $db -> createCommand('select pos_name from firm_position')->queryAll();
$sqlstr = "";
foreach ($na as $k => $v) {
    $a = $v['pos_name'];
 $sqlstr .= "{title:\"$a\"},";
...
<script type="text/javascript">
    $(function(){
        $("#tt").bigAutocomplete({width:604,data:[{title:"中国好声音",result:{ff:"中国声音"}},{title:"中国银行"},<?php echo $st?>,{title:"时间银行2"},{title:"时间银行"}],callback:function(data){
            name = data.title;
            //alert(data.title);
             $.ajax({
            type:'get',
            url:'<?= Url::toRoute(['index/list'])?>',
            data: {name:name},
                //dataType:'json',
...
<?php include_once('public/header.php'); ?>
    <div id="container">
        <div id="sidebar">
			<div class="mainNavs">
                <div class="menu_box">
				    <div class="menu_main">
						<h2>技术 <span></span></h2>
						<a href="?r=index/list&&name=Java&&city=$city">Java</a>
				        <a href="?r=index/list&&name=php&&city=$city">PHP</a>
				        <a href="?r=index/list&&name=C&&city=$city">C</a>
				...
				<dl class="reset">
					<dt><a href="h/jobs/list_前端开发?labelWords=label"></a></dt>
					<dd>
				...
				<dl class="reset">
					<dt><a href="h/jobs/list_测试?labelWords=label"></a></dt>
					<dd>
				...
				<dl class="reset">
					<dt><a href="h/jobs/list_运维?labelWords=label"></a></dt>
					<dd>
				...
				<dl class="reset">
					<dt><a href="h/jobs/list_DBA?labelWords=label"></a></dt>
					<dd>
        ...
        <input type="text" id="tt"  name = "firm_name" tabindex="1" value=""  placeholder="请输入职位名称，如：产品经理" style="width:600px;height:30px; line-height:30px;font-size:15px; border:2px #CCCCCC solid;"  />
       <!--  <input type="hidden" name="spc" id="spcInput" value=""/>name = "kd"
...
<dl class="hotSearch">
	<dt>热门搜索：</dt>
	<dd><a href="?r=index/list&&name=Java&&city=$city">Java</a></dd>
    <dd><a href="?r=index/list&&name=PHP&&city=">PHP</a></dd>
	<dd><a href="?r=index/list&&name=Android&&city=">Android</a></dd>
	<dd><a href="?r=index/list&&name=iOS&&city=">iOS</a></dd>
	<dd><a href="?r=index/list&&name=前端&&city=">前端</a></dd>
	<dd><a href="?r=index/list&&name=产品经理&&city=">产品经理</a></dd>
	<dd><a href="?r=index/list&&name=UI&&city=">UI</a></dd>
	<dd><a href="?r=index/list&&name=运营&&city=">运营</a></dd>
	<dd><a href="?r=index/list&&name=BD&&city=">BD</a></dd>
	<dd><a href="?r=index/list&&name=实习&&city=">实习</a></dd>
</dl>
			<div id="home_banner">
	            <ul class="banner_bg">
			...
			?>
	            	            <li class="clearfix" data-id="<?=$val['pos_id']?>">
		            																		            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="?r=index/list_show&&pos_id=<?=$val['pos_id']?>" target="_blank"><?= $val['pos_name'];?></a>
			                           
			                            <span class="c9"><?= $val['pos_city']?></span>
			                            			                        </div>
			                        <span><em class="c7">月薪：</em><?= $val['pos_salary_end']?></span>
			                        <span><em class="c7">经验：</em> 3-5年</span>
			                        <span><em class="c7">最低学历： </em>本科</span>
			                        <br />
			                        <span><em class="c7">职位诱惑：</em><?= $val['pos_tem']?></span>
			                        <br />
				                    <span>1天前发布</span>
			                        <!-- <a  class="wb">分享到微博</a>-->
			                    </div>
			    ...
			    <dl>
			        ...
			        <dd>
			        		...
			        		<a href="" target="_blank">UCloud</a> <span>|</span>
			          		...
			          		<a href=" target="_blank">php中文网</a> <span>|</span>
...
<script type="text/javascript" src="style/js/count.js"></script>
	...
	<div id="footer">
		<div class="wrapper">
			<a rel="nofollow" target="_blank" href="?r=index/about">联系我们</a>
		    <a href="h/af/zhaopin.html" target="_blank">互联网公司导航</a>
		    <a href="http://e.weibo.com/lagou720" target="_blank" rel="nofollow">拉勾微博</a>
		    <a class="footer_qr" href="javascript:void(0)" rel="nofollow">拉勾微信<i></i></a>
			<div class="copyright">&copy;2013-2014 Lagou <a target="_blank" href="http://www.php.cn">京ICP备14023790号-2</a></div>
		</div>
	</div>
